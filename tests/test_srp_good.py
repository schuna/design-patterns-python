...
from src.design_patterns.solid.srp_good.repository import Repository
from src.design_patterns.solid.srp_good.journal import Journal
...
class TestRepository(TestCase):
    ...
    def test_save_to_file_called_valid_store_journal(self):
        open_mock = mock_open()
        with patch("src.design_patterns.solid.srp_good.repository.open", open_mock, create=True):
